import { config as unoConfig } from "/package_4b8eb3045d852e20b135272b12567db47e05500a/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('cb12e3f9-8222-44e1-af09-d9d72a90a7ec').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'cb12e3f9-8222-44e1-af09-d9d72a90a7ec';
