import { config as unoConfig } from "/package_2e96d910df334b08ae1caae880f28e764094044a/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('1f5f1a6a-4f6a-4a37-9980-d1dd1ee44d3c').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '1f5f1a6a-4f6a-4a37-9980-d1dd1ee44d3c';
