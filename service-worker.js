import { config as unoConfig } from "/package_f83af835b009a041e20e1aaaa19b0454ad027e4b/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('cc525b9f-54c3-4abd-80dd-2f0730a0306d').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== 'cc525b9f-54c3-4abd-80dd-2f0730a0306d';
